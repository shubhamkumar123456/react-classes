...
// useEffect --> it is used to run side effect such as updating the DOM element fetching api etc; it takes two argumnent a callback function and a array of dependency. if array of dependency is blank it will run only one time
